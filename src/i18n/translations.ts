...
const id = {
  ...
  unsupported:'Format belum didukung. Gunakan CSV, TXT, XLSX, atau XLS.', empty:'File tidak berisi baris data.', readError:'File tidak dapat dibaca.', none:'Jangan masking', name:'Nama / deskripsi provider', email:'Email', dob:'Tanggal lahir', phone:'Nomor HP', address:'Alamat', code:'Kode / ID', confidence:'confidence', suggested:'Rekomendasi lain',
} as const
...
const en: Record<keyof typeof id, string> = {
  ...
  unsupported:'Unsupported format. Use CSV, TXT, XLSX, or XLS.', empty:'The file contains no data rows.', readError:'The file could not be read.', none:'Do not mask', name:'Name / provider description', email:'Email', dob:'Date of birth', phone:'Phone number', address:'Address', code:'Code / ID', confidence:'confidence', suggested:'Other suggestions',
}
