...
const id = {
  ...
  privacy:'PRIVASI DATA, TANPA RIBET', headline:'Samarkan data pribadi.', headlineAccent:'Aman, cepat, lokal.', intro:'Upload hasil query Anda, biarkan Maskara mengenali data sensitif secara otomatis, lalu download CSV yang sudah aman.', drop:'Tarik & lepas file di sini', or:'atau', chooseFile:'Pilih file', reading:'Membaca file…',
  noServer:'Tidak ada upload server', noServerDesc:'Data tidak pernah meninggalkan perangkat', smart:'Deteksi kolom pintar', smartDesc:'Kenali berbagai nama kolom & alias SQL', csvReady:'CSV siap pakai', csvReadyDesc:'Format universal untuk analisis',
  ...
  done:'SELESAI', safe:'Data sudah aman.', processed:'berhasil diproses dan CSV sudah diunduh ke perangkat Anda.', another:'Masking file lain', redownload:'Download ulang', ownership:'Data Anda tetap menjadi milik Anda.', localProcess:'Diproses lokal - Tanpa penyimpanan - Tanpa pelacakan',
...
const en: Record<keyof typeof id, string> = {
  ...
  privacy:'DATA PRIVACY, MADE SIMPLE', headline:'Mask personal data.', headlineAccent:'Safe, fast, local.', intro:'Upload your query result, let Maskara detect sensitive data automatically, then download a safe CSV.', drop:'Drag & drop your file here', or:'or', chooseFile:'Choose file', reading:'Reading file…',
  noServer:'No server upload', noServerDesc:'Data never leaves your device', smart:'Smart column detection', smartDesc:'Recognizes common columns & SQL aliases', csvReady:'Ready-to-use CSV', csvReadyDesc:'Universal format for analysis',
  changeFile:'Change file', config:'MASKING CONFIGURATION', review:'Review detection results', reviewDesc:'We have inferred the data types. You remain in full control.', rows:'rows', columns:'columns', sensitive:'sensitive fields detected', basedOn:'based on column names and SQL aliases', detectAgain:'Detect again', source:'Source column', maskType:'Masking type', example:'Result preview', willMask:'columns will be masked', consistent:'The same value always produces the same masked result.', maskDownload:'Mask & download CSV',
  done:'DONE', safe:'Your data is safe.', processed:'were processed and the CSV was downloaded to your device.', another:'Mask another file', redownload:'Download again', ownership:'Your data remains yours.', localProcess:'Processed locally - No storage - No tracking',
